...
func (r *Requester) ExtractInformation() {
	...
	// extract the name
	Name := doc.Find("div[class='_873b']").Text()
	// extract the image
	Image := doc.Find("img[class='img _99ny l img _1-yc _2sxw']").AttrOr("src", "pic")
	...
	EmailsOrPhones := []string{}
	doc.Find("div[class='_9o1y']").Each(func(i int, s *goquery.Selection) {
